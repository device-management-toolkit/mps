...
export enum messages {
  ...
  OPAQUE_MANAGEMENT_DATA_OWNER_EXCEPTION = 'Exception during opaque management data owner request',
  OPAQUE_MANAGEMENT_DATA_OWNER_GET_REQUESTED = 'Opaque management data owner request',
  OPAQUE_MANAGEMENT_DATA_OWNER_GET_REQUEST_FAILED = 'Opaque management data owner get request failed',
  OPAQUE_MANAGEMENT_DATA_OWNER_GET_SUCCESS = 'Opaque management data owner received'
}
