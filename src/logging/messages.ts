...
export enum messages {
  ...
  OPAQUE_MANAGEMENT_DATA_EXCEPTION = 'Exception during opaque management data request',
  OPAQUE_MANAGEMENT_DATA_GET_REQUESTED = 'Opaque management data request',
  OPAQUE_MANAGEMENT_DATA_GET_REQUEST_FAILED = 'Opaque management data get request failed',
  OPAQUE_MANAGEMENT_DATA_GET_SUCCESS = 'Opaque management data received',
