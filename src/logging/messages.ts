...
export enum messages {
  ...
  AMT_CERTIFICATES_EXCEPTION = 'Exception during AMT Certificates request',
  AMT_FEATURES_SET_EXCEPTION = 'Exception during AMT Features Set request',
  AMT_FEATURES_GET_REQUESTED = 'AMT Features requested',
  AMT_CERTIFICATES_GET_REQUESTED = 'AMT Certificates requested',
  ...
  NETWORK_SETTINGS_EXCEPTION = 'Exception during AMT Network Settings request',
  NETWORK_SETTINGS_REQUEST_FAILED = 'AMT Network Settings request failed',
  NETWORK_SETTINGS_NOT_FOUND = 'Network Settings not found',
  NETWORK_SETTINGS_GET_REQUESTED = 'Network Settings requested',
  NETWORK_SETTINGS_GET_SUCCESS = 'Network Settings received',
  WIRED_NETWORK_SETTINGS_GET_REQUESTED = 'Wired Network Settings requested',
  WIRED_NETWORK_SETTINGS_GET_SUCCESS = 'Wired Network Settings received',
  WIRED_NETWORK_SETTINGS_NOT_FOUND = 'Wired Network Settings not found',
  WIRED_NETWORK_SETTINGS_UPDATE_REQUESTED = 'Wired Network Settings update requested',
  WIRED_NETWORK_SETTINGS_UPDATE_SUCCESS = 'Wired Network Settings updated',
  WIRED_NETWORK_SETTINGS_UPDATE_FAILED = 'Wired Network Settings update failed',
  WIRED_8021X_NOT_SUPPORTED = 'Wired 802.1X configuration is not yet supported',
  WIRELESS_STATE_GET_REQUESTED = 'Wireless State requested',
  WIRELESS_STATE_GET_SUCCESS = 'Wireless State received',
  WIRELESS_STATE_NOT_FOUND = 'Wireless State not found',
  WIRELESS_STATE_UNSUPPORTED = 'Unsupported wireless state',
  WIRELESS_STATE_CHANGE_REQUESTED = 'Wireless State change requested',
  WIRELESS_STATE_CHANGE_SUCCESS = 'Wireless State changed',
  WIRELESS_STATE_CHANGE_FAILED = 'Wireless State change failed',
  WIRELESS_PROFILE_SYNC_GET_REQUESTED = 'Wireless Profile Sync requested',
  WIRELESS_PROFILE_SYNC_GET_SUCCESS = 'Wireless Profile Sync received',
  WIRELESS_PROFILE_SYNC_NOT_FOUND = 'Wireless Profile Sync not found',
  WIRELESS_PROFILE_SYNC_UEFI_NOT_SUPPORTED = 'UEFI WiFi profile sync is not supported on this device',
  WIRELESS_PROFILE_SYNC_UPDATE_REQUESTED = 'Wireless Profile Sync update requested',
  WIRELESS_PROFILE_SYNC_UPDATE_SUCCESS = 'Wireless Profile Sync updated',
  WIRELESS_PROFILE_SYNC_UPDATE_FAILED = 'Wireless Profile Sync update failed',
  WIRELESS_PROFILE_GET_REQUESTED = 'Wireless Profiles requested',
  WIRELESS_PROFILE_GET_SUCCESS = 'Wireless Profiles received',
  WIRELESS_PROFILE_GET_FAILED = 'Wireless Profiles request failed',
  WIRELESS_PROFILE_ADD_REQUESTED = 'Wireless Profile add requested',
  WIRELESS_PROFILE_ADD_SUCCESS = 'Wireless Profile added',
  WIRELESS_PROFILE_ADD_FAILED = 'Wireless Profile add failed',
  WIRELESS_PROFILE_ALREADY_EXISTS = 'Wireless Profile already exists',
  WIRELESS_PROFILE_PRIORITY_EXISTS = 'Wireless Profile with the requested priority already exists',
  WIRELESS_PROFILE_LIMIT_REACHED = 'Maximum number of wireless profiles already configured on the device',
  WIRELESS_PROFILE_UPDATE_REQUESTED = 'Wireless Profile update requested',
  WIRELESS_PROFILE_UPDATE_SUCCESS = 'Wireless Profile updated',
  WIRELESS_PROFILE_UPDATE_FAILED = 'Wireless Profile update failed',
  WIRELESS_PROFILE_DELETE_REQUESTED = 'Wireless Profile delete requested',
  WIRELESS_PROFILE_DELETE_SUCCESS = 'Wireless Profile deleted',
  WIRELESS_PROFILE_DELETE_FAILED = 'Wireless Profile delete failed',
  WIRELESS_PROFILE_NOT_FOUND = 'Wireless Profile not found',
  WIRELESS_PORT_NOT_FOUND = 'No WiFi port found on the device',
  OS_POWER_SAVING_STATE_EXCEPTION = 'Exception during OS Power Saving State request',
  OS_POWER_SAVING_STATE_GET_REQUESTED = 'OS Power Saving State requested',
  OS_POWER_SAVING_STATE_GET_FAILED = 'OS Power Saving State request failed',
  OS_POWER_SAVING_STATE_CHANGE_FAILED = 'Request to change the OS Power Saving State failed',
  OS_POWER_SAVING_STATE_CHANGE_REQUESTED = 'Request to change the OS Power Saving State submitted',
  ...
  BOOT_CAPABILITIES_REQUESTED = 'Boot Capabilities requested',
  BOOT_CAPABILITIES_SUCCESS = 'Boot Capabilities received',
  BOOT_CAPABILITIES_EXCEPTION = 'Exception during Boot Capabilities request',
